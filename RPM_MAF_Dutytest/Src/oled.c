...
const uint8_t F16x16_Idx[] = 
{
	...
	//"测距离周长面积度高坡亩仪搜索转速大小查记录删除系统值设单价公顷元询每电池压经纬°定型号版本剩余空间返回退出"
	"传感器总线面积度高坡亩仪搜索转速大小查记录删除系统值设单价公顷元询每电池压经纬°定型号版本剩余空间返回退出"
};
...
const uint8_t F16x16[] = 
{
	...
	0x40,0x30,0x00,0x03,0x39,0x41,0x41,0x45,0x59,0x41,0x41,0x73,0x00,0x08,0x30,0x00,//总3

	0x20,0x30,0xAC,0x63,0x20,0x18,0x80,0x90,0x90,0xFF,0x90,0x49,0x4A,0x48,0x40,0x00,
	0x22,0x67,0x22,0x12,0x12,0x12,0x40,0x40,0x20,0x13,0x0C,0x14,0x22,0x41,0xF8,0x00,//线4
	...
	0x08,0x18,0x08,0xFF,0x04,0x04,0x00,0x02,0x0B,0x12,0x22,0xD2,0x0A,0x06,0x00,0x00, //转",14

	0x40,0x40,0x42,0xCC,0x00,0x04,0xF4,0x94,0x94,0xFF,0x94,0x94,0xF4,0x04,0x00,0x00,
	0x00,0x40,0x20,0x1F,0x20,0x48,0x44,0x42,0x41,0x5F,0x41,0x42,0x44,0x48,0x40,0x00, //速",15
  ...
  0x80,0x40,0x20,0x1E,0x20,0x40,0x40,0x7F,0x44,0x44,0x44,0x44,0x44,0x40,0x40,0x00, //定40
...
void LCD_Print(uint8_t x, uint8_t y, char *ch,uint8_t char_size, uint8_t ascii_size)
{
	uint8_t ch2[3];
	uint8_t ii=0;        
	while(*(ch+ii) != '\0')
